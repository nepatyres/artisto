...
import ImgInput from './imageInput';
...
export default function CreateProduct({ setCreate }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        images.forEach((img) => {
            formData.append('images', img); // Use 'images' as the field name for each image
        });
                ...
                <div className='flex relative justify-center bg-white w-[600px] h-[700px] shadow-md rounded-lg'>
                    ...
                    <form onSubmit={handleSubmit} className='w-[80%] flex flex-col pt-5'>
                        ...
                        <div className='flex flex-col gap-5 pt-8'>
                            ...
                            <textarea className='border rounded-md px-2 py-3' placeholder='Product description' id="description" value={description} onChange={(e) => setDescription(e.target.value)} />
