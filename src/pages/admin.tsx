...
export default function Admin() {
    ...
    return (
        <div className="flex flex-col relative overflow-hidden min-h-screen w-[80%] mx-auto">
            <button className="self-end w-32 my-3 px-3 py-2 rounded-full text-white bg-green-300" onClick={createBtn}>Add product</button>
            <div className="grid grid-cols-5 h-auto w-full mx-auto">
                {products.map((product, i) => (
                    <div key={product.id} onClick={() => editBtn(product)} className="flex flex-row mt-5 ml-5 h-[220px] w-[200px] shadow-lg rounded-lg cursor-pointer">
