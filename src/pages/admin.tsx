...
export default function Admin() {
    ...
    return (
        <div className="flex flex-col relative overflow-hidden min-h-screen w-[80%] mx-auto">
            ...
            <div className="flex flex-col w-full h-[40vh] mb-8">
                <span className="text-2xl mb-5">Bestsellers</span>
                <div className="grid grid-cols-3 w-full h-full">
                    {bestsellers && bestsellers.map((bestseller, i) => (
                        <div className="h-[200px] w-[200px] bg-black"></div>
                    ))}
                    <div className="h-full w-full border border-black/30 rounded-lg cursor-pointer flex justify-center items-center" onClick={() => popupBtn(product, 'GET')}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24" viewBox="0 0 24 24" fill="none">
                            <g id="Edit / Add_Plus">
                                <path id="Vector" d="M6 12H12M12 12H18M12 12V18M12 12V6" className="stroke-black/70 stroke-1" strokeLinecap="round" strokeLinejoin="round" />
                            </g>
                        </svg>
                    </div>
                </div>
