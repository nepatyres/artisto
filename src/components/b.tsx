                ...
                <div className='flex justify-center w-[600px] h-[700px] shadow-md rounded-lg'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <input className='border rounded-md px-2 py-1' type="number" step="0.01" id="price" value={price} onChange={(e) => setPrice(e.target.value)} placeholder='Product price' required />
                            <input className='border rounded-md px-2 py-1' type="number" id="stock" value={stock} onChange={(e) => setStock(e.target.value)} placeholder='Product stock' required />
