            ...
            {accordion &&
                <>
                    <div className="flex flex-col w-full px-8 py-5 mb-5">
                        ...
                        <div className="grid grid-cols-3 w-full h-full gap-5 mb-5">
                            {bestseller && bestseller.map((bestseller, i) => (
                                <div key={i} className="h-full w-full border rounded-lg cursor-pointer flex relative">
                            ...
                            {bestseller.length < 3 && <div className="h-full w-full border border-black/30 rounded-lg cursor-pointer flex justify-center items-center" onClick={() => popupBtn(product, 'GET')}>
                    ...
                    <div className="flex flex-col w-full px-8 py-5 mb-5">
                        ...
                        <div className="grid grid-cols-4 w-full h-full gap-3 lg:gap-5 mb-5">
                            {bestseller && bestseller.map((bestseller, i) => (
                                <div key={i} className="h-full w-full border rounded-lg cursor-pointer flex relative">
                                    <img className="bg-cover w-full h-full object-center rounded-lg" src={bestseller.image} alt="" />
                                    <div className="flex absolute top-3 right-3">
                            ...
                            {bestseller.length < 4 && <div className="h-full w-full border border-black/30 rounded-lg cursor-pointer flex justify-center items-center" onClick={() => popupBtn(product, 'GET')}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24" viewBox="0 0 24 24" fill="none">
                                    <g id="Edit / Add_Plus">
                                        <path id="Vector" d="M6 12H12M12 12H18M12 12V18M12 12V6" className="stroke-black/70 stroke-[.6]" strokeLinecap="round" strokeLinejoin="round" />
                                    </g>
