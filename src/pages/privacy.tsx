    ...
    return (
        <div className="w-full min-h-full flex flex-col">
            ...
            <div className="flex flex-col mx-auto w-[80%] lg:w-[60%] xl:w-[50%] mt-40 mb-40 font-roboto h-min-[80vh]">
                ...
                <h2 className='text-xl font-semibold mt-5'>1. Information We Collect</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>2. How We Use Your Information</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>3. Sharing Your Information</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>4. Data Security</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>5. Data Security</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>6. Data Security</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>7. Third-Party Links</h2>
                ...
                <h2 className='text-xl font-semibold mt-5'>8. Changes to This Privacy Policy</h2>
