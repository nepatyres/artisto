...
export default function Navbar() {
    return (
        <nav className="fixed h-16 top-3 w-[95%] bg-black/40 rounded-3xl z-50 left-1/2 transform -translate-x-1/2">
            <div className="grid grid-cols-3 h-full mix-blend-difference">
                <div className="flex justify-start items-center text-white text-2xl uppercase pl-8">ARTISTO</div>
