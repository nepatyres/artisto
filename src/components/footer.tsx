    ...
    return (
        <footer className="w-full bg-black pt-6 pb-2 text-white rounded-t-2xl flex flex-col">
            <div className='w-[80%] lg:w-[90%] 2xl:w-[60%] justify-between mx-auto flex flex-col lg:flex-row mt-8 mb-6'>
                <div className=" flex flex-col w-[90%] pb-12 lg:hidden mx-auto">
                    {footer.map((foot, i) => (
                ...
                <div className="grid-cols-3 flex-col xl:flex-row justify-between items-start hidden lg:grid justify-self-center">
                    {footer.map((foot, i) => (
                ...
                <div className='flex flex-col justify-self-start pl-10 lg:pl-0'>
